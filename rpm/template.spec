...
Name:           ros-noetic-neo-local-planner
Version:        1.0.1
Release:        1%{?dist}%{?release_suffix}
Summary:        ROS neo_local_planner package
...
%description
This package provides a spline based implementation to local robot navigation on
a plane. This package's ROS wrapper adheres to the BaseLocalPlanner interface
...
%changelog
* Tue Jun 08 2021 Neobotix GmbH <ros@neobotix.de> - 1.0.1-1
